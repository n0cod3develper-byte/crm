-- ============================================================
-- Migración 041: Campos SOAT para Equipos (Vehículos)
-- Fecha: 2026-05-28
-- ============================================================

BEGIN;

-- 1. Agregar columnas SOAT a equipos
ALTER TABLE equipos
  ADD COLUMN IF NOT EXISTS soat_vigente     BOOLEAN DEFAULT false,
  ADD COLUMN IF NOT EXISTS soat_vencimiento DATE;

-- 2. Recrear vista equipos_completo incluyendo SOAT
-- (DROP + CREATE porque OR REPLACE no permite cambiar columnas)
