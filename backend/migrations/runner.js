...
// Archivos de migración cargados automáticamente
const MIGRATION_FILES = fs.readdirSync(__dirname)
  .filter(file => file.endsWith('.sql'))
  .sort((a, b) => {
    // Ordenar de forma natural para que 10_.. vaya después de 9_..
    return a.localeCompare(b, undefined, { numeric: true, sensitivity: 'base' });
  });

console.log(`📂 Se encontraron ${MIGRATION_FILES.length} archivos de migración.`);
