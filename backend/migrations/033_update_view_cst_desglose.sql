-- ============================================================
-- Migración 033: Actualiza resumen_turnos_tecnicos con nuevos
-- campos de desglose CST (minutos por categoría de recargo).
-- ============================================================
...
SELECT
  ...
  t.min_ord_nocturnos,
  t.min_extra_diurnos,
  t.min_extra_nocturnos,
  t.min_dom_fest_ord,
  t.min_dom_fest_extra_d,
  t.min_dom_fest_extra_n,
  t.es_domingo,
  t.es_festivo,
  t.nombre_festivo,
  -- Servicios
