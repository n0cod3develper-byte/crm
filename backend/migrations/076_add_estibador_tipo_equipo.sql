-- ============================================================
-- Migración 076: Agregar "Estibador" al catálogo Tipo de Activo
-- Fecha: 2026-07-14
-- ============================================================
--
-- Cambios:
--   1. Eliminar cualquier CHECK constraint existente sobre
--      tipo_equipo que pudiera bloquear el nuevo valor.
--   2. Recrear la vista equipos_completo incluyendo 'ESTIBADOR'
--      en la expresión CASE de tipo_equipo_label.
-- ============================================================

BEGIN;

-- 1. Eliminar CHECK constraints sobre tipo_equipo
...
-- 2. Recrear vista equipos_completo con ESTIBADOR en el CASE
