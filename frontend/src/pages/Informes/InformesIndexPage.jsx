...
import { BarChart3, Wrench, ArrowRight, Users, Fuel } from 'lucide-react';
      ...
      <div style={{
        ...
        <Link to="/informes/ventas-combustible" style={{ textDecoration: 'none', display: 'flex', height: '100%' }}>
          ...
          >
            ...
            <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem', lineHeight: 1.5, marginBottom: '1.5rem', flex: 1 }}>
              Remisiones con tipo de servicio que incluye combustible. Filtro por rango de fechas y exportación a CSV.
            </p>
