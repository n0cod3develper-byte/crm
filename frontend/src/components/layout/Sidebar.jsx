...
import {
  ...
  ShoppingCart, ShoppingBag, Receipt, Clock, BookOpen, MapPin, History, PlusCircle,
...
const navItems = [
  ...
  { label: 'Cotizaciones Clientes', icon: FileText, to: '/quotes', modulo: 'cotizaciones' },
  ...
  { label: 'Registrar Compra', icon: PlusCircle, to: '/compras?tab=registro', modulo: 'ordenes_compra', indent: true },
  { label: 'Historial Compras', icon: History, to: '/compras?tab=historial', modulo: 'ordenes_compra', indent: true },
