...
const TotalizadoFinalPage = lazy(() => import('./pages/Informes/TotalizadoFinalPage').then(m => ({ default: m.TotalizadoFinalPage })));
const LiquidacionGHPage   = lazy(() => import('./pages/Informes/LiquidacionGHPage').then(m => ({ default: m.LiquidacionGHPage })));
          ...
          <BrowserRouter basename={import.meta.env.PROD ? '/crm' : '/'}>
            <Suspense fallback={<PageLoader />}>
              <Routes>
                ...
                {/* Inventario */}
                <Route path="/inventory"              element={<ProtectedRoute modulo="inventario" accion="ver"><InventoryPage /></ProtectedRoute>} />
                <Route path="/inventory/ubicaciones"  element={<ProtectedRoute modulo="inventario" accion="ver"><UbicacionesPage /></ProtectedRoute>} />
                <Route path="/inventario/movimientos" element={<ProtectedRoute modulo="inventario" accion="ver"><MovementsPage /></ProtectedRoute>} />

                {/* Catálogo PRO */}
                <Route path="/catalogo"           element={<ProtectedRoute modulo="catalogo" accion="ver"><CatalogDashboardPage /></ProtectedRoute>} />
                <Route path="/catalogo/familias"  element={<ProtectedRoute modulo="catalogo" accion="ver"><FamiliesPage /></ProtectedRoute>} />
                <Route path="/catalogo/items"     element={<ProtectedRoute modulo="catalogo" accion="ver"><CatalogListPage /></ProtectedRoute>} />
                <Route path="/catalogo/nuevo"     element={<ProtectedRoute modulo="catalogo" accion="crear"><CatalogFormPage /></ProtectedRoute>} />
                <Route path="/catalogo/:id"       element={<ProtectedRoute modulo="catalogo" accion="ver"><CatalogItemDetailPage /></ProtectedRoute>} />
                <Route path="/catalogo/:id/editar" element={<ProtectedRoute modulo="catalogo" accion="editar"><CatalogFormPage /></ProtectedRoute>} />

                {/* Mantenimiento */}
                <Route path="/mantenimiento"                 element={<ProtectedRoute modulo="ordenes_trabajo" accion="ver"><MantenimientoPage /></ProtectedRoute>} />
                <Route path="/mantenimiento/nueva"           element={<ProtectedRoute modulo="ordenes_trabajo" accion="crear"><OTFormPage /></ProtectedRoute>} />
                <Route path="/mantenimiento/configuracion"   element={<ProtectedRoute adminOnly><PMAdminPage /></ProtectedRoute>} />
                <Route path="/mantenimiento/:id/editar"      element={<ProtectedRoute modulo="ordenes_trabajo" accion="editar"><OTFormPage /></ProtectedRoute>} />
                <Route path="/mantenimiento/:id"             element={<ProtectedRoute modulo="ordenes_trabajo" accion="ver"><OTDetailPage /></ProtectedRoute>} />
                ...
                {/* Catálogo de servicios / Remisiones */}
                <Route path="/catalogo-servicios"       element={<Navigate to="/catalogo" replace />} />
                ...
                <Route path="/informes/totalizado"  element={<ProtectedRoute><TotalizadoFinalPage /></ProtectedRoute>} />
                <Route path="/informes/liquidacion" element={<ProtectedRoute><LiquidacionGHPage /></ProtectedRoute>} />
              </Routes>
            </Suspense>
          </BrowserRouter>
        </PermissionsProvider>
